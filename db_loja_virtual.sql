...
--
-- Host: 127.0.0.1
-- Tempo de geração: 09-Jul-2023 às 00:42
...
CREATE TABLE `tb_imagens` (
  ...
  `id_produto` int(11) NOT NULL,
  `url_imagem` varchar(220) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(1, 1, '2023-06-27 17:15:58'),
(2, 2, '2023-06-27 17:26:11');
...
(4, 'HD Externo Portáril Seagate Expansion 1TB USB 3.0', 274.90);
